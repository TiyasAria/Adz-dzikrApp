...
import com.idn.smart.tiyas.adz_dzikrapp.Adapter.ViewPagerAdapterPT
import com.idn.smart.tiyas.adz_dzikrapp.Model.DataSore
import kotlinx.android.synthetic.main.activity_sore.*

class ActivitySore : AppCompatActivity() {

    private val soreAdapterPT = ViewPagerAdapterPT(
        listOf(
            DataSore("Membaca ayat Kursi",
        ...
        """.trimIndent()),
            DataSore("Membaca surat Al Ikhlas, Al Falaq, An Naas",
...
قُلْ أَعُوذُ بِرَبِّ النَّاسِ, مَلِكِ النَّاسِ ,إِلَهِ النَّاسِ ,مِن شَرِّ الْوَسْوَاسِ الْخَنَّاسِ ,الَّذِي يُوَسْوِسُ فِي صُدُورِ النَّاسِ, مِنَ الْجِنَّةِ وَ النَّاسِ
        ...
        """.trimIndent()
            ...
            DataSore("Membaca Doa ketika petang",
            ...
            DataSore("Membaca sayyidul istighfar",
                """
        ...
        """.trimIndent()),
            DataSore("Membaca Doa Pilihan Pagi/Petang",
